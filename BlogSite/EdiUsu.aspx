<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EdiUsu.aspx.cs" Inherits="BlogSite.EdiUsu" %>
     ...
     <div class="baseform">
        ...
        <div class="fila col10L">
         ...
         <%--<div class="fila col10L">
            ...
            <div class="fila col10L">
                <input class="formulario" placeholder="Contraseña" id="Contraseña" type="text"  runat="server"/>            
            </div>   
            <div class="fila col10L">
