<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true"  CodeBehind="EditarPub2.aspx.cs" Inherits="BlogSite.EditarPub2" %>
...
<body id="page-top">
    ...
    <script>
      $('#summernote').summernote({
        ...
        <br />
        <div class="fila col10L">                
                <center><asp:Button class="botonsubmit" value="REGISTRARME" type="submit"  runat="server" CssClass="botonsubmit"  OnClick="Unnamed1_Click"  Text="ACTUALIZAR ARTICULO"/></center>        
            </div>
